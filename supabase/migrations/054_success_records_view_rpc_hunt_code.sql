-- Fix: ensure success_records VIEW has hunt_code/hunt_type and get_success_records RPC matches
-- Resolves: "column sr.hunt_code does not exist" when RPC references columns missing from view
-- (e.g. if 051 was partially applied or view was from an older migration)

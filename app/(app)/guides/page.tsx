...
import InviteGuideCard from "@/app/(app)/guides/InviteGuideCard";
import GuidesList from "@/app/(app)/guides/GuidesList";
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
        <div>
          ...
          <p style={{ marginTop: 6, opacity: 0.75 }}>
            Invite guides and manage access for this outfitter.
          </p>
        </div>
      </div>
